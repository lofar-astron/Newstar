...
%       \Figref{.plotter.interface} and its companion \figref{.plotter.extract}
show
%schematically the various branches of program execution and the parameters
%that the user must provide to control each of them.

%\input {../fig/plotter_interface.cap}
